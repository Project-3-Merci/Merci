...
function AllFavoursPage() {
  ...
  return (
    <div>
      <h1 className="mt-2">All Favours Page</h1>
          ...
          return (
            ...
            <div key={favour._id} className="favour-preview card bg-secondary">
              ...
              <Link to={`/favour/${favour._id}`}>
                <button className="btn btn-dark border border-warning">See details</button>
              </Link>
              ...
              }} className="btn btn-dark border border-success text-success">Accept</button>):<p className="text-warning"> Sorry, this user doesn't have tokens!</p> }
            </div>
          )
      }
      )}
